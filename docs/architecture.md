...
- `demo/` — генератор синтетических сценариев для 8 правил (не часть production runtime).
...
`docs/adr/0012` (clean-install и full-stack demo verification). Модель угроз — в
