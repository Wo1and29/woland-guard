...
import repoStats from "./stats.generated.json";
...
const DICT = {
  ...
  "hero.watermark": { ru: "Session log · read-only агент", en: "Session log · read-only agent" },
  "rack.kicker": { ru: "// Как это выглядит", en: "// What it looks like" },
  ...
  "svc.card4Desc": { ru: "Telegram-бот с кнопками: принять инцидент, закрыть, подготовить dry-run план блокировки адреса — план исполняет оператор вручную, с одобрением второго администратора.", en: "A Telegram bot with buttons: take an incident, close it, prepare a dry-run IP-block plan — the operator runs it manually, with a second administrator's approval." },
  ...
  "ft.limits": { ru: "Ограничения MVP", en: "MVP limitations" },
  "ft.threat": { ru: "Threat model", en: "Threat model" }
};
function useT() {
...
function Project({ lang, t }) {
  ...
  const targets = [repoStats.linesProduction, repoStats.linesTests, repoStats.adrCount];
...
function Footer({ lang, t }) {
  const readmeLimits = lang === "ru"
    ? "https://github.com/Wo1and29/woland-guard#ограничения-mvp"
    : "https://github.com/Wo1and29/woland-guard/blob/master/README.en.md#mvp-limitations";
  ...
  }, "AGPL-3.0-or-later")), /*#__PURE__*/React.createElement("span", {
    className: "flex items-center gap-4"
  }, /*#__PURE__*/React.createElement("a", {
    className: "underline underline-offset-4 hover:text-signal",
    href: readmeLimits,
    target: "_blank", rel: "noopener"
  }, t("ft.limits")), /*#__PURE__*/React.createElement("a", {
    className: "underline underline-offset-4 hover:text-signal",
    href: "https://github.com/Wo1and29/woland-guard/blob/master/docs/threat-model.md",
    target: "_blank", rel: "noopener"
  }, t("ft.threat")))));
}
...
function App() {
  ...
  return /*#__PURE__*/React.createElement(MotionConfig, { reducedMotion: "user" }, /*#__PURE__*/React.createElement("div", {
    className: "bg-black"
  }, /*#__PURE__*/React.createElement(Navbar, { lang: lang, setLang: setLang, t: t }), /*#__PURE__*/React.createElement("main", null, /*#__PURE__*/React.createElement(Hero, { t: t }), /*#__PURE__*/React.createElement(NetworkSection, { t: t }), /*#__PURE__*/React.createElement(Services, { t: t }), /*#__PURE__*/React.createElement(Project, { lang: lang, t: t }), /*#__PURE__*/React.createElement(Pricing, { t: t }), /*#__PURE__*/React.createElement(Contact, { t: t })), /*#__PURE__*/React.createElement(Footer, { lang: lang, t: t })));
}
export default App;
